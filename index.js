        ...
        switch (page) {
            ...
            default:
                gui.parse([
					...
					{ text: `{12}<font color="#fcf9ea" size="+15">[hp&#xFF1A;1] </font>{/12}`, command: `slay 1` },
					{ text: `<font color="#fcf9ea" size="+15">[hp&#xFF1A;10] </font>`, command: `slay 10` },
					{ text: `<font color="#fcf9ea" size="+15">[hp&#xFF1A;20] </font>`, command: `slay 20` }, 			
					{ text: `<font color="#fcf9ea" size="+15">[hp&#xFF1A;30] </font>`, command: `slay 30` },
					{ text: `<font color="#fcf9ea" size="+15">[hp&#xFF1A;40] </font><br>`, command: `slay 40` },
